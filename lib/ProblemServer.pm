...
sub new {
    ...
    warn "ProblemServer: starting a new ProblemServer instance with new. ";
...
sub translation {
    ...
    $self->{problemEnviron}{displayMode} 	= translateDisplayModeNames($request->{displayMode})//'HTML_img';
...
sub generator {
    ...
    warn "Problemserver: starting the generator subroutine";
...
sub checker{
    ...
    warn "Problemserver:  starting the checker subroutine";
...
sub renderProblem {
    my ($self,$request) = @_;
    warn "Problemserver: SOAP call to renderProblem subroutine";
...
sub generateProblems {
    my ($self,$code,$seed,$trials) = @_;
    warn "Problemserver: SOAP call to generateProblems subroutine.";
    warn "arguments for generate problem ", join("\n", $code, $seed, $trials);
    my $server = $ProblemServer::theServer;
...
sub checkAnswers {
    ...
    warn "ProblemServer: SOAP call to checkAnswers subroutine.";
    my $server = $ProblemServer::theServer;
